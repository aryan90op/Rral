...
# ==== Runner (add this to make the script actually start the bot) ====
...
if __name__ == "__main__":
    ...
    if (not _token) or ("PASTE_YOUR_TELEGRAM_BOT_TOKEN_HERE" in _token):
        raise RuntimeError(
            "No Telegram bot token found. Set BOT_TOKEN env var in Termux (export BOT_TOKEN=...) "
            "or edit this file and replace PASTE_YOUR_TELEGRAM_BOT_TOKEN_HERE with your real token."
        )
